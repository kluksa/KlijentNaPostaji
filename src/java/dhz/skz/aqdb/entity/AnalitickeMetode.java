 ...
 */
@Entity
@Table(name = "analiticke_metode", catalog = "aq_t2", schema = "")
@XmlRootElement
@NamedQueries({
...
public class AnalitickeMetode implements Serializable {
    ...
    private static final Logger log = Logger.getLogger(AnalitickeMetode.class.getName());
    ...
    public String toString() {
        return "dhz.skz.likz.aqdb.entity.AnalitickeMetode[ id=" + id + " ]";
    }
